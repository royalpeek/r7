...
export default function StakingModal({ question, voteDirection, onConfirm, onCancel }: StakingModalProps) {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-slate-900 rounded-t-3xl p-8 z-50 max-w-screen">
        <div className="max-w-sm mx-auto">
          <div className="mb-8">
            <p className="text-sm font-bold mb-3 text-cyan-400">
              STAKE {voteDirection}
            </p>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-center mb-6">
              <span className="text-6xl font-bold text-cyan-400">${amount}</span>
