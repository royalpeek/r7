...
const activePositions = [
  ...
  {
    id: 2,
    question: 'Should couples split everything 50/50?',
    vote: 'NO',
    stake: 25,
    pnl: -4.20,
    timeLeft: '00:46:49',
...
const historyPositions = [
  {
    id: 3,
    question: 'Is trash talking necessary in sports?',
    vote: 'YES',
    stake: 100,
    pnl: +88.50,
    resolved: 'YES won',
  ...
  {
    id: 4,
    question: 'Do you think good people are always weak?',
    vote: 'NO',
    stake: 30,
    pnl: -30.00,
    resolved: 'YES won',
  ...
  {
    id: 5,
    question: 'Is climate change the biggest threat?',
    vote: 'YES',
    stake: 75,
    pnl: +60.00,
    resolved: 'YES won',
              ...
              {(Object.keys(sortLabel) as SortOption[]).map(option => (
                <button
                  ...
                  className={`w-full text-left px-4 py-3 text-sm ${
                    sortBy === option ? 'text-cyan-400 bg-slate-700' : 'text-slate-300'
                  }`}
                >
                  {sortLabel[option]}
                </button>
              ...
              <div key={pos.id} className="bg-slate-900 border border-slate-700 rounded-2xl p-5">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <span className={`text-xs font-bold px-2 py-1 rounded ${
                    pos.vote === 'YES' ? 'bg-cyan-900 text-cyan-400' : 'bg-pink-900 text-pink-400'
                  }`}>
                    {pos.vote}
                  </span>
                </div>
            ...
            <div key={pos.id} className="bg-slate-900 border border-slate-700 rounded-2xl p-5">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className={`text-xs font-semibold ${
                  pos.resolved.includes(pos.vote) ? 'text-cyan-400' : 'text-pink-400'
                }`}>
                  {pos.resolved}
                </span>
              </div>
